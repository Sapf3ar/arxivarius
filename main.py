...
def init_keys():
    """
    Initializes session state keys for message history and file upload status.
    """
...
def make_file_upload():
    """
    Marks the uploaded file status as True and logs the action.
    """
...
with st.container():
    """
    Renders the message history and prompts the user for input.
    """
